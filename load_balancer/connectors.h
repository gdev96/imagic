...
class server_connector {
    ...
    std::unordered_map<uint32_t, std::vector<unsigned int>> *request_map_;
...
public:
    server_connector() {}
    server_connector(sockaddr_in *server_address, std::unordered_map<uint32_t, std::vector<unsigned int>> *request_map);
